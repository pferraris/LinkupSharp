...
namespace LinkupSharpHttpListener.Net
{
    sealed class EndPointListener
    {
        ...
        public EndPointListener(HttpListener listener, IPAddress addr, int port, bool secure, X509Certificate cert)
        {
        ...
        private void ProcessAccept(Socket accepted)
        {
            try
            {
                ...
                HttpConnection conn = new HttpConnection(accepted, listener, listener.secure, listener.cert, connectionId);
